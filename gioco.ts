...
export class Gioco {
	// qui vengono dichiarate le variabili con i nomi dei 10 giocatori

	nomeGiocatore1: String;
	nomeGiocatore2: String;
	nomeGiocatore3: String;
	nomeGiocatore4: String;
	nomeGiocatore5: String;
	nomeGiocatore6: String;
	nomeGiocatore7: String;
	nomeGiocatore8: String;
	nomeGiocatore9: String;
	nomeGiocatore10: String;
